...
Monthly is also average price for the month. Formulas are below
"""
# %%
import pandas as pd
import math
...
#read ticker list
names = ['Tickers']
tix = pd.read_csv("disty_tickers.csv",names=names).values.tolist()
...
global_df.to_csv('bbg_weekly_disty.csv')
